...
#### Product Parts
Used as one-to-one relations table
#### Parts
1. name - Part name
2. type - Type of part (rim, color...)
3. price - Price of the part
4. stock - Used to mark if the part is available
#### Part Option Combinations
Used as one-to-many relations table

## The description of the main user actions in this e-commerce website
### The product page consists of ProductList and ProductItem component.
Product list renders the available products and on selection it triggers ProductItem Dialog that renders available options.
...
## Discussion Topics
  ...
  5. Anything related to the system architecture or component design
